    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 3:
                ...
                title = getString(R.string.title_concern);
                break;
            case 4:
                fragment = new ReportIncidentFragment();
                title = getString(R.string.title_incident);
                break;
            case 5:
                fragment = new FoodFragment();
                title = getString(R.string.title_management);
                break;
            case 6:
            ...
            case 11:
                fragment = new MessagesFragment();
                title = getString(R.string.title_options);
                break;
            default:
                break;
        }
